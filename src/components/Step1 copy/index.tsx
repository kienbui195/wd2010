      ...
      <Dialog
        ...
        <DialogContent className="transition-all transform">
          ...
          <div className="flex text-pink-500  flex-col items-center justify-center gap-4 text-center text-lg">
            ...
            />
            <FadeInText
              content="Em là một trong số đó bề ngoài tẻn tẻn mát mát, rất nhiều năng lượng tươi vui nhưng cũng là người tình
              cảm, sâu sắc luôn mang lại cho mọi người xung quanh cảm giác ấm áp, dễ chịu."
